...
def parse_args():
    ...
    parser.add_argument('hevm')
    parser.add_argument('exec')
    # contract runtime bytecode  $ solc xxx.sol --bin-runtime
    parser.add_argument('--code', dest='data', default='', type=str)
    # function signature bytecode
    parser.add_argument('--calldata', dest='signature', default='0x24ff38a2', type=str)
